...
const Page = async () => (
  <main className="m-auto max-w-content py-20 flex flex-col gap-20">
    <section>
      ...
      <p>
        Prostor funguje pod hlavičkou pobočného spolku Unijazz Boskovice. Ideově
        a stylově navazujeme na největší alternativní akci ve městě, na které se
    ...
    <section>
      <h2 className="typo-title2 mb-4">Program</h2>
      <div>(TBD)</div>
      <h3 className="typo-title3">Přihlas se k odběru programu emailem</h3>
      <p>
        Chceš dostávat pravidelné informace o programu a mít tak přehled o dění
        v Prostoru? Nech nám na sebe emailovou adresu a přihlaš se k odběru, ať
        ti můžeme čas od času napsat, co je v Prostoru nového. Adresu použijeme
        pouze pro informace týkající se Prostoru a neposkytneme ji nikomu
        jinému.
      </p>
    </section>
    ...
    <section>
      ...
      <p>
        ...
        především vytvářet soudržnou komunitu, která se na životě centra podílí
        a vytváří ho.
      </p>
      <p>
      ...
      <p>
        Členský příspěvek na činnost činí 200 korun za měsíc ve standardní výši
        a 500 korun či více za měsíc ve variantě mecenášské.
      </p>
      <p>
